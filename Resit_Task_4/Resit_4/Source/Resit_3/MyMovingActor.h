...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Input")
	UInputAction* RotUpDown;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Input")
	UInputAction* RotLeftRight;
	...
	void HandleRotUpDown(const FInputActionValue& Value);

	void HandleRotLeftRight(const FInputActionValue& Value);
